...
const common = merge([
	{
		...
		plugins: [
			...
			new HtmlWebpackPlugin({
				...
				// chunks: ['bundle'],
				// chunks: ['index', 'common'],
				template: PATHS.source + '/2.pug'
			}),
			new HtmlWebpackPlugin({
				filename: '3.html',
				// chunks: ['bundle'],
				// chunks: ['index', 'common'],
				template: PATHS.source + '/3.pug'
			}),
			new HtmlWebpackPlugin({
				filename: '4.html',
				// chunks: ['bundle'],
				// chunks: ['index', 'common'],
				template: PATHS.source + '/4.pug'
			}),
			new HtmlWebpackPlugin({
				filename: 'enter.html',
				chunks: ['bundle'],
			...
			new HtmlWebpackPlugin({
				...
				chunks: ['bundle'],
				// chunks: ['index', 'common'],
				template: PATHS.source + '/registration.pug'
			}),
			new HtmlWebpackPlugin({
			...
			new HtmlWebpackPlugin({
				...
				chunks: ['bundle'],
				// chunks: ['index', 'common'],
				template: PATHS.source + '/compare.pug'
			}),
			new HtmlWebpackPlugin({
